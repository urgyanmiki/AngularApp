...
export class ProductmanageService {
  ...
  getProducts() {
    ...
    this.http
      .get<{ message: string; product: any }>("api/products")
    ...
    deleteProduct(id: string){
      this.http.delete("api/products/delete" + id).subscribe(()=>{
    ...
    findOne(id){
      console.log(id)
      this.http.get<{message: string, product: any}>("api/products/find"+ id);
    }
}
